    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0 ">
            <div class=" flex flex-col ">
                <p class=" animate__animated  animate__lightSpeedInRight text-center">All in One </p>
                <p class=" animate__animated  animate__lightSpeedInLeft" > Management Tool</p>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            <h1>Streamline Telecom Sites Management</h1>
            <p>The complete solution for field engineers to track modifications, control budgets, and analyze network
                performance - all in one platform.</p>
            <div class="hero-buttons">
                <a href="#cta" class="btn-primary">Get Started Now</a>
    ...
    <section class="features" id="features">
        <div class="container">
            ...
            <p class="section-subtitle">Designed specifically for Orange telecom field engineers to manage sites
                efficiently</p>
            <div class="features-grid">
                <div class="feature-card">
                    <div class="feature-icon">NUR</div>
                    <h3>Network Unavailability Ratio Analysis</h3>
                    <p>Track and analyze NUR metrics across all telecom sites with advanced reporting tools. Identify
                        patterns, predict issues, and maintain optimal network performance with real-time data insights.
                    </p>
                </div>

                <div class="feature-card">
                    <div class="feature-icon">DB</div>
                    <h3>Comprehensive Site Database</h3>
                    <p>Access a centralized database of all telecom sites with detailed information, maintenance
                        history, equipment inventory, and site documentation at your fingertips.</p>
                </div>

                <div class="feature-card">
                    <div class="feature-icon">€</div>
                    <h3>Budget Tracking & Control</h3>
                    <p>Monitor modification action costs in real-time, track budget allocation, and control expenses
                        with automated alerts. Generate financial reports instantly and prevent budget overruns before
                        they happen.</p>
                </div>
            </div>
        </div>
    ...
    <section class="benefits" id="benefits">
        <div class="container">
            <div class="benefits-content">
                <div>
                    <h2 class="section-title" style="text-align: left; color: white; margin-bottom: 30px;">Maximize
                        Efficiency, Minimize Costs</h2>
                    <ul class="benefits-list">
                        <li>Cut administrative time by up to 60% with automated tracking</li>
                        <li>Reduce modification action costs by 45% through better visibility</li>
                        <li>Eliminate manual data entry and paperwork</li>
                        <li>Real-time budget alerts prevent overspending</li>
                        <li>Instant access to site information from any device</li>
                        <li>Generate reports in seconds, not hours</li>
                        <li>Make data-driven decisions with NUR analytics</li>
                    </ul>
                </div>
                <div class="highlight-box">
                    <h3>Built for Field Engineers</h3>
                    <p>Our platform is specifically designed for Orange telecom field engineers who need to track
                        modification actions efficiently while maintaining strict budget control. Stop wasting time on
                        spreadsheets and manual processes - focus on what matters most.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="cta-section" id="cta">
        <div class="container">
            ...
            <p>Join our field engineers who are saving time and cutting costs with our all-in-one solution.</p>
    ...
    <footer>
        <div class="container">
            <p>&copy; 2025 All in One Management Tool for Telecom. All rights reserved.</p>
        </div>
    </footer>
</body>
